...
public class EndToEndTest {
	...
	public Response createEmployee(String name, int salary) {
		...
		Response response = this.request.contentType(ContentType.JSON).accept(ContentType.JSON).body(mapObj).post("employees/create");
		return response;
	}	
	...
	public Response updateEmployee(int empId, String name, int salary) {
		...
		mapObj.put("name", name);
		mapObj.put("salary", salary);
		Response response = this.request.contentType(ContentType.JSON).accept(ContentType.JSON).body(mapObj).patch("employees/update/" + empId);
		return response;
	}	
